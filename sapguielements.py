...
class SAPGuiElements:
    ...
    @staticmethod
    def press_keyboard_keys(sap_session, keys, window_id=sapgui.GUI_MAIN_WINDOW):
    ...
    @staticmethod
    def __send_vkey(sap_session, vkey, window_id=sapgui.GUI_MAIN_WINDOW):
    ...
    @staticmethod
    def get_status_message(sap_session, window_id=sapgui.GUI_MAIN_WINDOW):
    ...
    @staticmethod
    def get_scroll_position(sap_session, area_id=sapgui.GUI_MAIN_USER_AREA):
    ...
    @staticmethod
    def get_max_scroll_position(sap_session, area_id=sapgui.GUI_MAIN_USER_AREA):
        scroll_element = SAPGuiElements.__get_element(sap_session, area_id)
        if scroll_element.type in GUI_SCROLL_TYPES:
    ...
    @staticmethod
    def set_scroll_position(sap_session, position, area_id=sapgui.GUI_MAIN_USER_AREA):
        scroll_element = SAPGuiElements.__get_element(sap_session, area_id)
        if scroll_element.type in GUI_SCROLL_TYPES:
    ...
    @staticmethod
    def call_menu(sap_session, menu_names, window_id=sapgui.GUI_MAIN_WINDOW):
