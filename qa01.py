...
class QA01:
    ...
    def create(sap_session, lote_inspecao):
        ...
        analisando_produto = lote_inspecao.origem == "89"
        ...
        SAPGuiElements.set_text(sap_session, ORIGIN_BATCH_ELEMENT, lote_inspecao.origem)
        ...
        if analisando_produto:
            ...
            SAPGuiElements.set_text(sap_session, TEXT_ELEMENT, lote_inspecao.texto_breve)
        else:
        ...
        try:
            ...
            if error_message:
                return False, QA01.get_formated_error_message(error_message, lote_inspecao.texto_breve)
            ...
            if tipo_mensagem and tipo_mensagem == 'S':
                ...
                return False, QA01.get_formated_error_message(message, lote_inspecao.texto_breve)
